    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.roles.create") }}">
                {{ trans('acl::global.add') }} {{ trans('acl::cruds.role.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('acl::cruds.role.title_singular') }} {{ trans('acl::global.list') }}
    </div>
    <div class="card-body">
                    ...
                    @foreach($roles as $key => $role)
                        <tr data-entry-id="{{ $role->id }}">
                            ...
                            <td>
                                ...
                                @can('role_delete')
                                    <form action="{{ route('admin.roles.destroy', $role->id) }}" method="POST" onsubmit="return confirm('{{ trans('acl::global.areYouSure') }}');" style="display: inline-block;">
